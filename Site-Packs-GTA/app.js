// On l'appelle supabaseClient au lieu de supabase pour éviter le conflit avec le script externe
...
async function loadData() {
    try {
        ...
        document.getElementById('packs-grid').innerHTML = '<p style="color: #ff4d4d; text-align:center; width:100%;">Erreur de connexion à la base de données. Vérifie ton config.js</p>';
    }
}
